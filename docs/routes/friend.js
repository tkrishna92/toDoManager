...
setRouter = (app) => {
    ...
    /**
     * @api {post} /friends/sendFriendRequest send friend request
     * @apiVersion 1.0.0
     * @apiGroup friend
     * 
    ...
    /**
     * @api{get} /friends/checkRequest check friend requests
     * @apiVersion 1.0.0
     * @apiGroup friend
     * 
     * @apiParam {String} authToken authToken of the user sending the request to be sent as header/body/query/path parameter
    ...
    /**
     * @api {post} /friends/acceptFriend accept friend request
     * @apiVersion 1.0.0
     * @apiGroup friend
     * 
     * @apiParam {String} authToken authToken of the user sending the request to be sent as header/body/query/path parameter
    ...
    /**
     * @api {post} /friends/friendCheck check selected user friend status
     * @apiVersion 1.0.0
     * @apiGroup friend
     * 
     * @apiParam {String} authToken authToken of the user sending the request to be sent as header/body/query/path parameter
