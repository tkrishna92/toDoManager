...
let setRouter = (app)=>{
    ...
    /**
     * @api {post} /toDo/createNewList create new list
     * @apiVersion 1.0.0
     * @apiGroup list
     * 
    ...
    /**
     * @api {post} /toDo/createNewItem create new list item
     * @apiVersion 1.0.0
     * @apiGroup list-item
     * 
    ...
    /**
     * @api {post} /toDo/editItem edit list-item
     * @apiVersion 1.0.0
     * @apiGroup list-item
     *
     * @apiParam {String} authToken authToken of the user creating the item to be passed as body/path/query/header param
    ...
    /**
     * @api {post} /toDo/editList edit list details
     * @apiVersion 1.0.0
     * @apiGroup list
     *
     * @apiParam {String} authToken authToken of the user creating the item to be passed as body/path/query/header param
    ...
    /**
     * @api {post} /toDo/deleteItem delete list item
     * @apiVersion 1.0.0
     * @apiGroup list-item
     *
     * @apiParam {String} authToken authToken of the user creating the item to be passed as body/path/query/header param 
    ...
    /**
     * @api {post} /toDo/deleteList delete list
     * @apiVersion 1.0.0
     * @apiGroup list
     *
     * @apiParam {String} authToken authToken of the user creating the item to be passed as body/path/query/header param 
    ...
    /**
     * @api {post} /toDo/getUserAllLists get all lists of user
     * @apiVersion 1.0.0
     * @apiGroup list
     *
     * @apiParam {String} authToken authToken of the user creating the item to be passed as body/path/query/header param 
    ...
    /**
     * @api {post} /toDo/getAllListItems get all items of a list
     * @apiVersion 1.0.0
     * @apiGroup list-item
     *
     * @apiParam {String} authToken authToken of the user creating the item to be passed as body/path/query/header param 
    ...
    /**
     * @api {post} /toDo/markItemAsDone mark an item as done
     * @apiVersion 1.0.0
     * @apiGroup list-item
     *
     * @apiParam {String} authToken authToken of the user creating the item to be passed as body/path/query/header param 
    ...
    /**
     * @api {post} /toDo/markItemAsOpen re-open an item
     * @apiVersion 1.0.0
     * @apiGroup list-item
     *
     * @apiParam {String} authToken authToken of the user creating the item to be passed as body/path/query/header param 
    ...
    /**
     * @api {post} /toDo/markItemAsDone mark a list as done
     * @apiVersion 1.0.0
     * @apiGroup list
     *
    ...
    /**
     * @api {post} /toDo/markItemAsOpen re-open a list
     * @apiVersion 1.0.0
     * @apiGroup list
     *
     * @apiParam {String} authToken authToken of the user creating the list to be passed as body/path/query/header param 
    ...
    /**
     * @api {post} /toDo/undoAction undo item action
     * @apiVersion 1.0.0
     * @apiGroup list-item
     *
     * @apiParam {String} authToken authToken of the user creating the item to be passed as body/path/query/header param
    ...
    /**
     * @api {post} /toDo/redoAction redo list action
     * @apiVersion 1.0.0
     * @apiGroup list-item
     *
     * @apiParam {String} authToken authToken of the user creating the item to be passed as body/path/query/header param
    ...
    /**
     * @api {post} /toDo/undiListAction undo list action
     * @apiVersion 1.0.0
     * @apiGroup list
     *
     * @apiParam {String} authToken authToken of the user creating the item to be passed as body/path/query/header param
    ...
    /**
     * @api {post} /toDo/redoListAction redo list action
     * @apiVersion 1.0.0
     * @apiGroup list
     *
     * @apiParam {String} authToken authToken of the user creating the item to be passed as body/path/query/header param
